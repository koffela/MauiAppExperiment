...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670636, ; uint32_t jnienv_initialize_method_token (0x6001cac)
	i32 100670635, ; uint32_t jnienv_registerjninatives_method_token (0x6001cab)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 623980692307826931, ; hash 0x8a8d32237b5d8f3, from name: aot-MauiAppExperiment.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6573978087568369204, ; hash 0x5b3b763d7eb6e634, from name: MauiAppExperiment.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 149
	...
	%struct.DSOCacheEntry {
		i64 12566421520187530870, ; hash 0xae64e5caf89a1e76, from name: aot-MauiAppExperiment
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 15287985471316348461, ; hash 0xd429d5c97524ce2d, from name: MauiAppExperiment
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
	...
	%struct.DSOCacheEntry {
		i64 17205936067543957723, ; hash 0xeec7c3b1460a00db, from name: libaot-MauiAppExperiment.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
	...
	%struct.DSOCacheEntry {
		i64 18388525943758192610, ; hash 0xff312aeb54c2ffe2, from name: libaot-MauiAppExperiment
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppExperiment.dll.so
		ptr null; void* handle (0x0)
	}, ; 477
...
@.env.3 = private unnamed_addr constant [37 x i8] c"c51b3f00-8a35-4267-b2ea-9ca3865b9b7d\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.mauiappexperiment\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-MauiAppExperiment.dll.so\00", align 16
